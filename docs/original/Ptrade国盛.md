...
- <!-- <li class="level3"><a href="#send_qywx" title="send_qywx - 发送企业微信信息">send_qywx - 发送企业微信信息</a></li> -->
...
- <!-- <li class="level1"><a href="#常见问题" title="常见问题">常见问题</a></li> -->
...
| [set\_parameters(回测/交易)](#set_parameters)                       |                                                                |                                                           |
...
| [check\_limit(交易)](#check_limit)                                   | [send\_email(交易)](#send_email)<!-- <td><a href="#send_qywx">send_qywx(交易)</a></td> --> |                                                                |
| [get\_MACD(回测/交易)](#get_MACD)                                      | [get\_KDJ(回测/交易)](#get_KDJ)                                                            | [get\_RSI(回测/交易)](#get_RSI)                                    |
...
### get\_individual\_transcation – 获取逐笔成交行情
...
<!-- <h3 id="send_qywx">send_qywx - 发送企业微信信息</h3> -->

<!-- <pre class="prettyprint"><code class="language-python">send_qywx(corp_id, secret, agent_id, info='', path='', toparty='', touser= '', totag= '')</code></pre> -->
...
<!-- <p>该接口用于通过企业微信发送内容，使用方法请查看<a href="/data/send_qywx" target="_blank"> 企业微信功能使用手册</a>。</p> -->

<!-- <p style="color: red">注意事项：<p> -->

<!-- <p>1、该接口需要服务端连通外网，是否开通由所在券商决定</p> -->

<!-- <p>2、是否允许发送文件（即path参数），由所在券商的配置管理决定</p> -->

<!-- <p>3、企业微信不能同时发送文字和文件，当同时入参info和path的时候，默认发送文件</p> -->

<!-- <p>4、企业微信接受到的文件为文件名而非文件路径</p> -->

<!-- <h4>参数</h4> -->

<!-- <p>corp_id：企业ID，必填字段(str)；</p> -->

<!-- <p>secret：企业微信应用的密码，必填字段(str)；</p> -->

<!-- <p>agent_id：企业微信应用的ID，必填字段(str)；</p> -->

<!-- <p>info：发送内容，选填字段，默认空字符串(str)；</p> -->

<!-- <p>path：发送文件，选填字段，如:'/home/fly/notebook/stock.csv'，默认空字符串(str)；</p> -->

<!-- <p>toparty：发送对象为部门，选填字段，默认空字符串(str)，多个对象之间用 '|' 符号分割；</p> -->

<!-- <p>touser：发送内容为个人，选填字段，默认空字符串(str)，多个对象之间用 '|' 符号分割；</p> -->

<!-- <p>totag：发送内容为分组，选填字段，默认空字符串(str)，多个对象之间用 '|' 符号分割；</p> -->

<!-- <p style="color: red">注意：toparty、touser、totag如果都不传入，接口默认发送至应用中设定的第一个toparty</p> -->
...
<!-- send_qywx('wwxxxxxxxxxxxxf9', 'hixxxxxxxxxxxxxxxxxxxBX8', '10xxxx3', info='已触发委托买入', toparty='1|2')</code></pre> -->
...
<!-- <p>使用本平台受阻，可参考<a href="/data/QA_data" target="_blank">常见问题说明</a></p> -->
...
3) [get\_snapshot()](#get_snapshot)新增支持获取XBHS行业版块市场数据；
   <!-- <li><a href="#send_qywx">send_qywx()</a>新增toparty(发送对象为部门)、touser(发送内容为个人)、totag(发送内容为分组)入参；</li> -->                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
4. 修复[get\_individual\_entrust()](#get_individual_entrust)和[get\_individual\_transcation()](#get_individual_transcation)中stocks入参代码数量大于50只时返回数据缺失问题；
